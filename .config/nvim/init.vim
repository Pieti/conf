...
Plug 'knubie/vim-kitty-navigator'       " navigate vim and kitty splits seamlessly
Plug 'tpope/vim-surround'               " easy edit for surrounds (brackets, quotes, tags, etc...)
Plug 'tpope/vim-repeat'                 " Add repeat support for some plugins
